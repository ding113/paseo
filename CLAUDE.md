...
| [docs/translation.md](docs/translation.md)                           | Runtime machine translation of agent output and composer input — why not a plugin, direction, batching                         |
...
| [docs/macos-app-sandbox.md](docs/macos-app-sandbox.md)               | Why the Mac App Store build cannot host the daemon, what no entitlement can fix, and the external-daemon path                  |
