...
That rule scopes this system — static copy shipped in the locale resources. Runtime machine translation of dynamic content is a separate feature that does translate agent output, and the two never share a key. See [translation.md](translation.md).
